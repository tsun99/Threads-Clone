...
extension User {
    static var MOCK_USERS: [User] = [
        ...
        .init(id: NSUUID().uuidString, email: "dracom@gmail.com", username: "dracoM", fullname: "Draco Malfoy", followers: 3, profileImageUrl: nil, bio: "I tried to kill Snape and failed"),
